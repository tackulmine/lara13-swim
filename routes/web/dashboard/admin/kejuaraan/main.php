...
Route::namespace('Kejuaraan')->prefix('kejuaraan')->as('kejuaraan.')->group(function () {
    Route::middleware('role:coach')->namespace('Event')->prefix('event')->as('event.')->group(function () {
        ...
        Route::namespace('Participant')->prefix('{event}/participant')->as('participant.')->group(function () {
    ...
    Route::middleware('role:coach')->namespace('Gaya')->prefix('gaya')->as('gaya.')->group(function () {
    ...
    Route::middleware('role:coach,member')->namespace('Report')->prefix('report')->as('report.')->group(function () {

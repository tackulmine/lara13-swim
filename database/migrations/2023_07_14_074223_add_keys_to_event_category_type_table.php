...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('event_category_type', function (Blueprint $table) {
            ...
            $table->primary(['event_id', 'master_match_category_id', 'master_match_type_id'], 'event_category_type_primary');
        });
    }
    ...
    public function down()
    {
        Schema::table('event_category_type', function (Blueprint $table) {
            ...
            $table->dropPrimary('event_category_type_primary');
        });
    }
};

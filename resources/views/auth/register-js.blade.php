...
<script src="//cdn.jsdelivr.net/npm/signature_pad@5.1.3/dist/signature_pad.umd.min.js"></script>
<script>
  ...
  const saveOKButton = wrapper.querySelector("[data-action=save-ok]");
  ...
  //     `width=${canvas.width / window.devicePixelRatio},height=${canvas.height / window.devicePixelRatio}`);
...
{!! JsValidator::formRequest('App\Http\Requests\RegisterRequest', '#member-registration') !!}

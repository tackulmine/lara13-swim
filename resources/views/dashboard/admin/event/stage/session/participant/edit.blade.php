    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href="{{ route($baseRouteName . 'index', [$event->id, $eventStage->id, $eventSession->id]) . getQueryHttpBuilder() }}"
    ...
    <div class="modal fade" id="modal-delete" tabIndex="-1">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <form
              action="{{ route($baseRouteName . 'destroy', [$event->id, $eventStage->id, $eventSession->id, $id]) . getQueryHttpBuilder() }}"
              method="post">
              {{ csrf_field() }}
              {{ method_field('DELETE') }}
              <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Tutup</button>

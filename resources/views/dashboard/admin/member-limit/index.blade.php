  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      ...
      <div class="table-responsive">
        ...
        <form action="{{ route('dashboard.admin.member-limit.destroy-batch') }}" method="post" class="mb-4"
          id="limit-form">
          @csrf
          @method('delete')
          ...
          <table class="table table-striped table-bordered" id="dataTableCustom" width="100%" cellspacing="0"
            data-order="[[ 2, &quot;asc&quot; ],[ 5, &quot;asc&quot; ],[ 4, &quot;asc&quot; ],[ 3, &quot;asc&quot; ]]">
            <thead>
            ...
            <tbody>
              @foreach ($limits as $limit)
                ...
                <tr>
                  ...
                  <td><a href="#!" data-toggle="tooltip" data-order="{{ $user->username }}"

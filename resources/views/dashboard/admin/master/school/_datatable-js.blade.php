<script>
  $(document).ready(function() {
    ...
    $(document).on('click', '#dataTablesCheckbox', function() {
      ...
      $('#masterschool-table input[type="checkbox"]').prop('checked', this.checked);
    });
    ...
    $('#school-form').on('submit', function(e) {
      ...
      if (confirm(
        ...
        // console.log('checkboxes:', $('#masterschool-table tbody input[type="checkbox"]').length);
        $('#masterschool-table tbody input[type="checkbox"]').each(function() {
    ...
    $(document).on('init.dt', function(e, settings) {
      ...
      // console.log(state);
      if (state !== null) {
        $('#masterschool-table thead tr.filter th').each(function(i) {
          if (i >= 1 && i <= 4) {
    ...
    $(document).on('click', '.dt-buttons .buttons-reset', function() {
      $('#masterschool-table thead tr.filter th input[type="search"]').each(function(i) {
        $(this).val('');
      });
    });
  });

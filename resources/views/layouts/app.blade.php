...
<head>
  ...
  <link rel="stylesheet" href="/assets/plugins/fancybox/3.5.7/jquery.fancybox.min.css" />
...
<body id="page-top">
  ...
  <script src="//cdn.sheetjs.com/xlsx-0.20.1/package/dist/xlsx.full.min.js"></script>
  ...
  <script>
    ...
    var initSelectToMe = function() {
      // Init select2
      $(".select2me").select2();
    };

    var reTriggerSelectToMe = function() {

...
class MasterParticipantDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->filterColumn('estafet', function ($query, $keyword) {
                $query->having('event_session_participant_details_count', intval($keyword));
            })
            ...
            ->orderColumn('estafet', function ($query, $order) {
                $query->orderBy('event_session_participant_details_count', $order ?? 'asc');
            })
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('gaya')->data('styles_count')
                ...
                ->searchable(false)
                ->addClass('text-right no-search'),
            Column::make('estafet')->data('event_session_participant_details_count')
                ->title(__('Estafet'))
                ->orderable(true)
                ->searchable(false)
                ->addClass('text-right no-search'),
